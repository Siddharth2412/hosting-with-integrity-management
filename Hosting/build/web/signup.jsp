    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form action="register.jsp" method="post">
                ...
                <div class="form-group"><input class="form-control" type="password" name="pswd" placeholder="Password" minlength="6" required></div>
                <div class="form-group"><input class="form-control" type="password" name="cpswd" placeholder="Password (repeat)" minlength="6" required></div>
